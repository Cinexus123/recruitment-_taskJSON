...
public class ListAvailableFoldersController {
    ...
    public String getFullIdFolder(@PathVariable("query") String query, @PathVariable("skip") Integer skip, @PathVariable("limit") Integer limit) {
